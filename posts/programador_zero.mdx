...
Linguagens de programação úteis para codificação de aplicações desktop:
<br/>
<b>- Java</b> - <a href="https://docs.oracle.com/en/java/" className="border-b transition-all text-gray-500 duration-500 hover:border-gray-500" target="_blank">https://docs.oracle.com/en/java/ </a> <br/>
<b>- C#</b> - C# -  <a href="https://learn.microsoft.com/pt-br/dotnet/csharp/tour-of-csharp/" className="border-b transition-all text-gray-500 duration-500 hover:border-gray-500" target="_blank">https://learn.microsoft.com/pt-br/dotnet/csharp/tour-of-csharp/ </a> <br/>
<b>- Python</b> -  <a href="https://docs.python.org/pt-br/3/" className="border-b transition-all text-gray-500 duration-500 hover:border-gray-500" target="_blank">https://docs.python.org/pt-br/3/ </a> <br/>
<b>- C</b> -  <a href="https://learn.microsoft.com/pt-br/cpp/c-language/?view=msvc-170" className="border-b transition-all text-gray-500 duration-500 hover:border-gray-500" target="_blank">https://learn.microsoft.com/pt-br/cpp/c-language/?view=msvc-170 </a> <br/>
